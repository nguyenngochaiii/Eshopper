                ...
                <div class="col-sm-9">
                    <div class="blog-post-area">
                        ...
                        <div class="single-blog-post">
                            ...
                            <a href="">
                                <img src="/themes/Eshopper/images/blog/blog-one.jpg" alt="">
                            </a>
                            <p>
                    ...
                    <div class="socials-share">
                        <a href=""><img src="/themes/Eshopper/images/blog/socials.png" alt=""></a>
                    </div>
                    <!--/socials-share-->

                    <div class="media commnets">
                        <a class="pull-left" href="#">
                            <img class="media-object" src="/themes/Eshopper/images/blog/man-one.jpg" alt="">
                        </a>
                    ...
                    <div class="response-area">
                        ...
                        <ul class="media-list">
                            <li class="media">
                                ...
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="/themes/Eshopper/images/blog/man-two.jpg" alt="">
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media second-media">
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="/themes/Eshopper/images/blog/man-three.jpg" alt="">
                                </a>
                                <div class="media-body">
                                    <ul class="sinlge-post-meta">
                                        <li><i class="fa fa-user"></i>Janis Gallagher</li>
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="/themes/Eshopper/images/blog/man-four.jpg" alt="">
                                </a>
                                <div class="media-body">
                                    <ul class="sinlge-post-meta">
                                        <li><i class="fa fa-user"></i>Janis Gallagher</li>
